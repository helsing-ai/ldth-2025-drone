...
async fn main() -> Result<()> {
    ...
    let channel = Channel::from_static("http://172.237.101.153:10301")
        .connect()
        .await?;
    ...
    // let message = response_stream.message().await;
    ...
    // go to http://172.237.101.153:8080 in a browser to see live results!
    Ok(())
}
